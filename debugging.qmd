# Top Debugging Steps {#sec-appendix-debugging}
...
## 2. Is the package/library installed and loaded?
...
## 3. Is the data loaded in the global environment?
