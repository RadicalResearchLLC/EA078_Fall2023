...
Go [here](http://radicalresearch.llc/EA078_Fall2023) to see all course materials.
...
All code used is on [github](https://github.com/RadicalResearchLLC/EA078_Fall2023)
...
Assignments <- c('Group Project - data visualization', 'Individual project 1 - written critique of existing visualization', 
                ...
                'Extra Credit')
Points <- c(250, 150, 150, 150, 150, 150, 50)
...
-   Thursday at 9:00 - 10:30 on [Pitzer Zoom](https://pitzer.zoom.us/j/2600893680)
-   Friday at 1:00 - 2:00 on zoom [Pitzer Zoom](https://pitzer.zoom.us/j/2600893680) 
...
All course materials will be hosted on [github](https://github.com/RadicalResearchLLC/EA078_Fall2023).

Go [here](http://radicalresearch.llc/EA078_Fall2023/) to see all course materials.

## COVID policy

COVID-19 safety guidelines and recommendations continue to evolve. Please read Pitzer's [Pathway Forward](https://www.pitzer.edu/pathway-forward/) and [Support](https://www.pitzer.edu/pathway-forward/covid-19-support/) and visit the Student Health Services (SHS) [COVID page](https://services.claremont.edu/covid/) for the latest campus information and guidance.

![SneezeCFD](images/COVID_mask.png)

All applicable campus and LA County policies will apply in this class and I will follow them to the extent feasible. If mask wearing is optional under Pitzer and LA County guidelines, then it is in this classroom as well. If you need to sneeze, cover up with an elbow...
