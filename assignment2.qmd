...
due.Date <- c('September 25, 2023', 'September 25, 2023', 'September 25, 2023', 'September 25, 2023', 'October 2, 2023', 'October 2, 2023')
...
Assignment is currently due **October 9th, 2023** at the beginning of class (9:45 AM). Please send the `.R script` and an exported visualization via email. This assignment is worth 150 points. Coding style will not be graded. Scripts will be used to reproduce the figure on my local machine - deviations between code and exported figure will likely result in deducted points.
