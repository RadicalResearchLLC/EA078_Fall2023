...
@fig-Biodiversity shows the areas of high and low biodiversity in SoCal. I incorporated a legend, color palette, and used the Positron Tile layer instead of OSM.

```{r}
#| label: fig-Biodiversity
#| fig-cap: Biodiversity categories in Southern California
#| echo: true
