...
Graphical design or [content](https://epa.maps.arcgis.com/apps/MapSeries/index.html?appid=e5a7e59018c7424eaddcb64b31ba4a41) may be repellent or triggering. In the syllabus, the COVID sneeze imagery is both factual model data and an intentionally gross way of visualizing the data to generate a feeling of disgust.
