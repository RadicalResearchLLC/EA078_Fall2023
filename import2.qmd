...
![Another folder is in the working directory!](/images/double.png){#fig-panel3} \### Import the Shapefile
...
7. Check the *Files* panel. Is **DataRecords.geojson** there?   
...
ggplot(data = CA_EJI_raw) +
  geom_sf(aes(fill = epl_dslpm), linewidth = 0) +
  theme_bw()
